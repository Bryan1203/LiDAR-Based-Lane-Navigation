...
if(NOT "/home/gem/bobabee_ws/src/hardware_drivers/arena_camera/include " STREQUAL " ")
  set(arena_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/gem/bobabee_ws/src/hardware_drivers/arena_camera/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'arena_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gem/bobabee_ws/src/hardware_drivers/arena_camera/${idir}'.  ${_report}")
    endif()
