...
echo_and_run cd "/home/gem/BobaBee_ws/src/hardware_drivers/geonav_transform"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/gem/BobaBee_ws/src/hardware_drivers/geonav_transform/setup.py" \
     \
    build --build-base "/home/gem/BobaBee_ws/build/hardware_drivers/geonav_transform" \
    install \
    --root="${DESTDIR-/}" \
