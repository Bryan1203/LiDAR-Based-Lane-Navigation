...
class PointCloudInference:
    def __init__(self):
        ...
        # Load model weights
        weight_path = rospy.get_param('~weight_path', '/media/kevin/Steven 2TB/484/train_highbay_07/model/model_best.pth')
    ...
    def inference_callback(self, msg):
        try:
            ...
            for point in pc2.read_points(msg, skip_nans=True):
                points.append([point[0], point[1], point[2], point[3]/65532])  # x, y, z, near_ir is 7th attribute but 3rd on filtered
